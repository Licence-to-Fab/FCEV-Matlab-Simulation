...
#include "FCElectricPlant_ac851afd_1_ds_vmf.h"
...
int32_T FCElectricPlant_ac851afd_1_ds_vmf ( const NeDynamicSystem * LC ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 575 ] = { true , true , false , false , false , false , false ,
...
) LC ; out = t2 -> mVMF ; for ( b = 0 ; b < 575 ; b ++ ) { t0 [ b ] =
