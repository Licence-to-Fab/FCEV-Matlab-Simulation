...
#include "FCElectricPlant_ac851afd_1_ds_obs_il.h"
...
int32_T FCElectricPlant_ac851afd_1_ds_obs_il ( const NeDynamicSystem * LC ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 2582 ] = { true , false , true , true , true , true , true ,
...
, true , true , true , true , true , true , false , false , true , true ,
false , true , false , false , false , false , false , true } ; PmBoolVector
out ; int32_T b ; boolean_T t0 [ 2582 ] ; ( void ) t1 ; ( void ) LC ; out =
t2 -> mOBS_IL ; for ( b = 0 ; b < 2582 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b
] ; } for ( b = 0 ; b < 2582 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void
) LC ; ( void ) t2 ; return 0 ; }
